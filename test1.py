...
#        batch_accuracy = compute_accuracy(x, attentions, y)
        ...
        if print_samples:
            print('Document ID: {}'.format(start+1), end=" ")
...
#        total_accuracy += batch_accuracy
        ...
        ansList.append([str(counter), idx2string(idx2word, [guess])])
#        csv1.write(str(counter), idx2string(idx2word, [guess]))
        counter=counter+1
